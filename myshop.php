...
<body class="">
   <div class="container-fluid">
    <div class="col-md-12"> 
     <div class="row">
         <h1 class="text-success my-3 text-center">Home</h1>
         <?php
include 'Config.php';
...
if($checkpage === 'Home'){
    ...
    <div class='card m-auto' style='width: 18rem;'>
        <img src='$imagePath' height='250px' width='180px' class='card-img-top'>
        <div class='card-body text-center '>
            <h5 class='card-title text-dark fs-4 fw-bold'>{$row['PName']}</h5>
            <p class='card-text text-dark fs-4 fw-bold'>RS: {$row['PPrice']}</p>
